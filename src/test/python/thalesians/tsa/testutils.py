...
class TestUtils(unittest.TestCase):
    ...
    def test_bracket(self):
        ...
        self.assertSequenceEqual(brackets, [
                utils.Bracket(utils.Interval(dt.date(2017, 2, 8), dt.date(2017, 2, 13), left_closed=True), 1),
                utils.Bracket(utils.Interval(dt.date(2017, 2, 13), dt.date(2017, 2, 18), left_closed=True), 2),
                utils.Bracket(utils.Interval(dt.date(2017, 2, 23), dt.date(2017, 2, 28), left_closed=True), 4),
                utils.Bracket(utils.Interval(dt.date(2017, 2, 28), dt.date(2017, 3, 5), left_closed=True), 5),
                utils.Bracket(utils.Interval(dt.date(2017, 3, 5), dt.date(2017, 3, 10), left_closed=True), 6),
                utils.Bracket(utils.Interval(dt.date(2017, 3, 20), dt.date(2017, 3, 25), left_closed=True), 9),
                utils.Bracket(utils.Interval(dt.date(2017, 4, 19), dt.date(2017, 4, 24), left_closed=True), 15),
                utils.Bracket(utils.Interval(dt.date(2017, 4, 24), dt.date(2017, 4, 29), left_closed=True), 16)])
        self.assertSequenceEqual(bracket_indices, [0, 0, 0, 1, 1, 2, 3, 4, 5, 5, 5, 6, 7])

        brackets, bracket_indices = utils.bracket(data, dt.date(2017, 2, 3), dt.timedelta(days=5), intervals_right_closed=True)
        self.assertSequenceEqual(brackets, [
                utils.Bracket(utils.Interval(dt.date(2017, 2, 3), dt.date(2017, 2, 8), right_closed=True), 0),
                utils.Bracket(utils.Interval(dt.date(2017, 2, 8), dt.date(2017, 2, 13), right_closed=True), 1),
                utils.Bracket(utils.Interval(dt.date(2017, 2, 13), dt.date(2017, 2, 18), right_closed=True), 2),
                utils.Bracket(utils.Interval(dt.date(2017, 2, 23), dt.date(2017, 2, 28), right_closed=True), 4),
                utils.Bracket(utils.Interval(dt.date(2017, 2, 28), dt.date(2017, 3, 5), right_closed=True), 5),
                utils.Bracket(utils.Interval(dt.date(2017, 3, 5), dt.date(2017, 3, 10), right_closed=True), 6),
                utils.Bracket(utils.Interval(dt.date(2017, 3, 20), dt.date(2017, 3, 25), right_closed=True), 9),
                utils.Bracket(utils.Interval(dt.date(2017, 4, 19), dt.date(2017, 4, 24), right_closed=True), 15),
                utils.Bracket(utils.Interval(dt.date(2017, 4, 24), dt.date(2017, 4, 29), right_closed=True), 16)])
        self.assertSequenceEqual(bracket_indices, [0, 1, 1, 1, 2, 3, 4, 5, 6, 6, 6, 7, 8])

        brackets, bracket_indices = utils.bracket(data, dt.date(2017, 2, 3), dt.timedelta(days=5), coalesce=True)
        self.assertSequenceEqual(brackets, [
                utils.Bracket(utils.Interval(dt.date(2017, 2, 8), dt.date(2017, 2, 18), left_closed=True), 1),
                utils.Bracket(utils.Interval(dt.date(2017, 2, 23), dt.date(2017, 3, 10), left_closed=True), 4),
                utils.Bracket(utils.Interval(dt.date(2017, 3, 20), dt.date(2017, 3, 25), left_closed=True), 9),
                utils.Bracket(utils.Interval(dt.date(2017, 4, 19), dt.date(2017, 4, 29), left_closed=True), 15)])
        self.assertSequenceEqual(bracket_indices, [0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3])
        ...
        self.assertSequenceEqual(brackets, [
                utils.Bracket(utils.Interval(dt.date(2017, 2, 3), dt.date(2017, 2, 18), right_closed=True), 0),
                utils.Bracket(utils.Interval(dt.date(2017, 2, 23), dt.date(2017, 3, 10), right_closed=True), 4),
                utils.Bracket(utils.Interval(dt.date(2017, 3, 20), dt.date(2017, 3, 25), right_closed=True), 9),
                utils.Bracket(utils.Interval(dt.date(2017, 4, 19), dt.date(2017, 4, 29), right_closed=True), 15)])
        self.assertSequenceEqual(bracket_indices, [0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3])
        ...
        self.assertSequenceEqual(brackets, [
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 8), dt.datetime(2017, 1, 31, 0, 13), left_closed=True), 1),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 13), dt.datetime(2017, 1, 31, 0, 18), left_closed=True), 2),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 23), dt.datetime(2017, 1, 31, 0, 28), left_closed=True), 4),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 28), dt.datetime(2017, 1, 31, 0, 33), left_closed=True), 5),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 33), dt.datetime(2017, 1, 31, 0, 38), left_closed=True), 6),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 48), dt.datetime(2017, 1, 31, 0, 53), left_closed=True), 9),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 1, 18), dt.datetime(2017, 1, 31, 1, 23), left_closed=True), 15),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 1, 23), dt.datetime(2017, 1, 31, 1, 28), left_closed=True), 16)])
        self.assertSequenceEqual(bracket_indices, [0, 0, 0, 1, 1, 2, 3, 4, 5, 5, 5, 6, 7])
        ...
        self.assertSequenceEqual(brackets, [
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 3), dt.datetime(2017, 1, 31, 0, 8), right_closed=True), 0),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 8), dt.datetime(2017, 1, 31, 0, 13), right_closed=True), 1),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 13), dt.datetime(2017, 1, 31, 0, 18), right_closed=True), 2),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 23), dt.datetime(2017, 1, 31, 0, 28), right_closed=True), 4),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 28), dt.datetime(2017, 1, 31, 0, 33), right_closed=True), 5),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 33), dt.datetime(2017, 1, 31, 0, 38), right_closed=True), 6),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 48), dt.datetime(2017, 1, 31, 0, 53), right_closed=True), 9),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 1, 18), dt.datetime(2017, 1, 31, 1, 23), right_closed=True), 15),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 1, 23), dt.datetime(2017, 1, 31, 1, 28), right_closed=True), 16)])
        self.assertSequenceEqual(bracket_indices, [0, 1, 1, 1, 2, 3, 4, 5, 6, 6, 6, 7, 8])

        brackets, bracket_indices = utils.bracket(data, dt.datetime(2017, 1, 31, 0, 3, 0), dt.timedelta(minutes=5), coalesce=True)
        self.assertSequenceEqual(brackets, [
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 8), dt.datetime(2017, 1, 31, 0, 18), left_closed=True), 1),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 23), dt.datetime(2017, 1, 31, 0, 38), left_closed=True), 4),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 48), dt.datetime(2017, 1, 31, 0, 53), left_closed=True), 9),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 1, 18), dt.datetime(2017, 1, 31, 1, 28), left_closed=True), 15)])
        self.assertSequenceEqual(bracket_indices, [0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3])
        ...
        self.assertSequenceEqual(brackets, [
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 3), dt.datetime(2017, 1, 31, 0, 18), right_closed=True), 0),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 23), dt.datetime(2017, 1, 31, 0, 38), right_closed=True), 4),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 0, 48), dt.datetime(2017, 1, 31, 0, 53), right_closed=True), 9),
                utils.Bracket(utils.Interval(dt.datetime(2017, 1, 31, 1, 18), dt.datetime(2017, 1, 31, 1, 28), right_closed=True), 15)])
        self.assertSequenceEqual(bracket_indices, [0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3])
