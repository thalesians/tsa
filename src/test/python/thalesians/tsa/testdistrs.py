...
class TestDistrs(unittest.TestCase):
    ...
    def test_multinomial_resample(self):
        ...
        npt.assert_almost_equal(resampled_approx_normal_empirical_2d.particle(0), npu.col(*particles[0]))
        ...
        npt.assert_almost_equal(subsampled_approx_normal_empirical_2d.particle(0), npu.col(*particles[0]))
